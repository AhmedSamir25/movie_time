...
import 'package:movietime/features/home_detils/presentation/view/widgets/profile_actor.dart';
...
abstract class AppRouter {
  ...
  static const profileActor = '/profileActor';
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) => MultiBlocProvider(providers: [
          BlocProvider(
            create: (context) => ProfileActorCubit(
              getIt.get<HomeDetailsRepoImpl>(),
            ),
          ),
        ], child: ProfileActor(castModel: state.extra as CastModel)),
      ),
    ],
  );
}